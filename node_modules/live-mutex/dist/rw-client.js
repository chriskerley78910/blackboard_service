    ...
    beginRead(key, opts, cb) {
        ...
        this.lock(key, opts, (err, unlock) => {
            ...
            if (!Number.isInteger(readers)) {
                return this.fireLockCallbackWithError(cb, new client_1.LMXClientLockException(key, unlock.id, index_1.LMXLockRequestError.InternalError, 'Implementation error, missing "readersCount".'));
            }
