...
c.ensure().then(function (c) {
    ...
    c.unlock(v.key, unlockOptions, function (e) {
        if (e) {
            ...
            client_1.log.error(`To discover what is going on with the broker, use ${chalk_1.default.bold.blueBright('$ lm_inspect_broker -p <port> -h <host>')}.`);
            return process.exit(1);
        }
        client_1.log.debug(chalk_1.default.green.bold(`${chalk_1.default.italic('Unlocked/released')} lock for key:`), `'${chalk_1.default.blueBright.bold(v.key)}'`);
        process.exit(0);
    });
});
